...
function getFridayInitialTemplate(name, comp) {
...
function getFridayFU1Template(name, comp) {
  return {
...
function getFridayFU2Template(name, comp) {
  return {
...
function getFridayFU3Template(name, comp) {
  return {
...
function getFridayProfessionalFooter() {
  return `
    <br><br>
...
function sendFridayHTMLSequenceEmails() {
...
function processFridayEmail(
  ...
  if (
    ...
    const template =
      getFridayInitialTemplate(name, comp);
  ...
  if (
    ...
    sendFridayFollowUp(
      ...
      threadId,
      messageId,
      getFridayFU1Template(name, comp),
      "FU1 Sent"
    );
  ...
  if (
    ...
    sendFridayFollowUp(
      ...
      threadId,
      messageId,
      getFridayFU2Template(name, comp),
      "FU2 Sent"
    );
  ...
  if (
    ...
    sendFridayFollowUp(
      ...
      threadId,
      messageId,
      getFridayFU3Template(name, comp),
      "Completed"
    );
...
function sendFridayFollowUp(
   ...
   **********************************************************/
  const initialTemplate = getFridayInitialTemplate(name, comp);
  const replySubject = "Re: " + initialTemplate.subject;


  const finalBody =
    template.body +
    getFridayProfessionalFooter();
