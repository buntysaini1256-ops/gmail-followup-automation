...
function getThursdayInitialTemplate(name, comp) {
...
function getThursdayFU1Template(name, comp) {
  return {
...
function getThursdayFU2Template(name, comp) {
  return {
...
function getThursdayFU3Template(name, comp) {
  return {
...
function getThursdayProfessionalFooter() {
  return `
    <br><br>
...
function sendThursdayHTMLSequenceEmails() {
...
function processThursdayEmail(
  ...
  if (
    ...
    const template =
      getThursdayInitialTemplate(name, comp);
  ...
  if (
    ...
    sendThursdayFollowUp(
      ...
      threadId,
      messageId,
      getThursdayFU1Template(name, comp),
      "FU1 Sent"
    );
  ...
  if (
    ...
    sendThursdayFollowUp(
      ...
      threadId,
      messageId,
      getThursdayFU2Template(name, comp),
      "FU2 Sent"
    );
  ...
  if (
    ...
    sendThursdayFollowUp(
      ...
      threadId,
      messageId,
      getThursdayFU3Template(name, comp),
      "Completed"
    );
...
function sendThursdayFollowUp(
   ...
   **********************************************************/
  const initialTemplate = getThursdayInitialTemplate(name, comp);
  const replySubject = "Re: " + initialTemplate.subject;


  const finalBody =
    template.body +
    getThursdayProfessionalFooter();
