...
function getMondayInitialTemplate(name, comp) {
...
function getMondayFU1Template(name, comp) {
  return {
...
function getMondayFU2Template(name, comp) {
  return {
...
function getMondayFU3Template(name, comp) {
  return {
...
function getMondayProfessionalFooter() {
  return `
    <br><br>
...
function sendMondayHTMLSequenceEmails() {
...
function processMondayEmail(
  ...
  if (
    ...
    const template =
      getMondayInitialTemplate(name, comp);
  ...
  if (
    ...
    sendMondayFollowUp(
      ...
      threadId,
      messageId,
      getMondayFU1Template(name, comp),
      "FU1 Sent"
    );
  ...
  if (
    ...
    sendMondayFollowUp(
      ...
      threadId,
      messageId,
      getMondayFU2Template(name, comp),
      "FU2 Sent"
    );
  ...
  if (
    ...
    sendMondayFollowUp(
      ...
      threadId,
      messageId,
      getMondayFU3Template(name, comp),
      "Completed"
    );
...
function sendMondayFollowUp(
   ...
   **********************************************************/
  const initialTemplate = getMondayInitialTemplate(name, comp);
  const replySubject = "Re: " + initialTemplate.subject;


  const finalBody =
    template.body +
    getMondayProfessionalFooter();
